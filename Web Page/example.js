* !stripe - js 04 - 10 - 2019 * /
    (function() {
        ...
        if (o = "https://js.stripe.com", g = "https://js.stripe.com", i = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), h = /MSIE 9/i.test(navigator.userAgent), f = "console" in window && "warn" in window.console, e = function() { var a; return (null != (a = window.performance) && "function" == typeof a.now ? a.now() : void 0) || ("function" == typeof Date.now ? Date.now() : void 0) || +new Date }, n = e(), l = {}, !i && "querySelectorAll" in document && f && (m = document.querySelectorAll('script[src^="' + o + '"]'), m.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")), a = function() {
                ...
                return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.StripeV3 = null, a.setPublishableKey = function(b) { var c, d; if (a.key = b, a.utils.validateProtocol(a.key), d = /^pk_test_/.test(a.key), h && d && !a.acknowledgeIE9Deprecation) throw c = "Starting in December 2018, stripe.js v2 and Checkout will no longer support IE9, per Microsoft's lifecycle policy\n\nThis error is being thrown only in IE9 in testmode so that you have an opportunity to update your integration or your browser testing strategy.\n\nIf you want to suppress this error in testmode until December, you can add:\n  Stripe.acknowledgeIE9Deprecation = true\nbefore you call Stripe.setPublishableKey", f && console.warn(c), new Error(c) }, a._language = "en-US", a.setLanguage = function(b) { return a._language = b }, a._allowedCustomHeaders = ["X-Stripe-Livemode", "Authorization"], a._customHeaders = {}, a._setCustomHeader = function(a, b) {
                ...
                }, a.request = function(a, b) { return this.trackPerf && a.tokenType ? this._instrumentedRequest(a, b) : this._rawRequest(a, b) }, a._rawRequest = function(b, c) {
                    var d, e, f;
                    if (b.data || (b.data = {}), e = "POST" === b.method && "object" == typeof(null != (f = b.data) ? f.card : void 0), c || (null != b.data.payment_user_agent ? this._isChannel || (b.data.payment_user_agent = "" + b.data.payment_user_agent + " (" + a.stripejs_ua + ")") : b.data.payment_user_agent = a.stripejs_ua), "iframe" === this._transport) {
                        ...
                        if ("cors" === this._finalTransport) try { return this.xhr(b) } catch (g) { return d = g, this._transport = "jsonp", this.request(b, !0) }
                        return this.ajaxJSONP(b)
                    }
                    if ("cors" === this._transport) try { return this.xhr(b) } catch (g) { return d = g, a.reportError("XhrThrewError"), this._transport = "jsonp", this.request(b, !0) }
                    return this.ajaxJSONP(b)
                }, a.reportError = function(b, c) { var d; return "console" in window && "warn" in window.console, 1, d = Math.round((new Date).getTime() / 1e3), (new Image).src = "https://q.stripe.com?event=stripejs-error&type=" + encodeURIComponent(b) + (c ? "&timing=" + c : "") + "&key=" + a.key + "&timestamp=" + d + "&payment_user_agent=" + encodeURIComponent(a.stripejs_ua) }, a._instrumentedRequest = function(b, c) { var d, e; return d = (new Date).getTime(), e = function(c) { return function(e, f) { var g, h, i, j, k; return j = null != (k = b.tokenType) ? k : "unknown", g = (new Date).getTime(), h = c._getResourceTiming(null != e ? e.responseURL : void 0), i = { event: "rum.stripejs", tokenType: j, url: b.url, status: f, start: d, end: g, resourceTiming: h }, a.logRUM(i) } }(this), b.success = function(a) { return function(b, c, d) { return e(d, c), a.apply(this, arguments) } }(b.success), b.complete = function(a) { return function(b, c, d) { return "success" !== b && e(c, b), a.apply(this, arguments) } }(b.complete), this._rawRequest(b, c) }, a._getResourceTiming = function(a) {
                    var b;
        ...
        for (this.Stripe = a, this.Stripe.token = function() {
                ...
                return s(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function(b, d, f) {
                    ...
                    try { i = Object.keys(l), i.length > 0 && (d.pasted_fields = i.sort().join(",")) } catch (j) { h = j }
                ...
                function c() { return c.__super__.constructor.apply(this, arguments) }
                return s(c, b), c.tokenName = "pii", c.whitelistedAttrs = ["personal_id_number"], c.createToken = function(b, d, e) { return null == d && (d = {}), a.token.validate(b, "pii data"), "function" == typeof d && (e = d, d = {}), d[c.tokenName] = a.token.formatData(b, c.whitelistedAttrs), a.token.create(d, e) }, c.getToken = function(b, c) { return a.token.get(b, c) }, c
        ...
        if (this.Stripe.stripejs_ua = "stripe.js/551a9ed", !this.Stripe._isChannel && true) try {
            "function" == typeof window.addEventListener && window.addEventListener("message", function(b) { var c, d; if (null == a.StripeV3 && !a.isDoubleLoaded) { try { c = a.JSON.parse(b.data) } catch (e) { return void(d = e) } return "m" === (null != c ? c.originatingScript : void 0) && /stripe\.com$/.test(b.origin) ? a.__sid = c.payload : void 0 } }, !1), k = !1, b = function() {
    ...
    function() {
        this.Stripe.isDoubleLoaded || ! function(a, b, c, d, e, f) {
            ...
            function j(a, b) { return L ? void a.call(b) : void M.push(function() { a.call(b) }) }
    ...
    function() {
        ...
        b = (new Date).getTime(), a = !1, this.Stripe.isDoubleLoaded || (this.Stripe.ajaxJSONP = function(d) {
            ...
            }, i = (d.headers || {})["Accept-Language"], k = (d.headers || {})["Stripe-Account"], d.data || (d.data = {}), d.data.callback = g, d.method && (d.data._method = d.method), i && (d.data._accept_language = i), k && (d.data._stripe_account = k), j.src = d.url + "?" + Stripe.utils.serialize(d.data), h = document.getElementsByTagName("head")[0], h.appendChild(j), d.timeout > 0 && (f = setTimeout(function() { return l.abort("timeout") }, d.timeout)), l)
        })
    }.call(this),
    function() {
        ...
        this.Stripe.isDoubleLoaded || (b = { contentType: "application/x-www-form-urlencoded", accept: { json: "application/json" } }, g = /^(20\d|1223)$/, f = "invalid_json_response", d = function(a, b, c) { return function() { return a._aborted ? c(a.request, "abort") : a.request && 4 === a.request.readyState ? (a.request.onreadystatechange = function() {}, 0 === a.request.status ? c(a.request, "empty_response") : g.test(a.request.status) ? b(a.request, a.request.status) : b(a.request, a.request.status)) : void 0 } }, h = function(a, c) {
            ...
            return this.url = a.url, this.timeout = null, this._successHandler = function() {}, this._errorHandlers = [], this._completeHandlers = [], a.timeout && (this.timeout = setTimeout(function(a) { return function() { return a.abort() } }(this), a.timeout)), a.success && (this._successHandler = function() { return a.success.apply(a, arguments) }), a.error && this._errorHandlers.push(function() { return a.error.apply(a, arguments) }), a.complete && this._completeHandlers.push(function() { return a.complete.apply(a, arguments) }), b = function(b) { return function(c, d) { var e; for (a.timeout && clearTimeout(b.timeout), b.timeout = null, e = []; b._completeHandlers.length > 0;) e.push(b._completeHandlers.shift()(d, c, a)); return e } }(this), e = function(a) { return function(c, e) { var g, h, i; if (i = c.responseText, i && i.length) { h = void 0; try { h = Stripe.JSON.parse(i) } catch (j) { return g = j, d(c, f) } return a._successHandler(h, e, c), b(h, "success") } return d(c, "empty_response") } }(this), d = function(a) {
                return function(b, c) {
                    var d, e, g;
                    if (g = b.responseText, e = void 0, g && g.length && c !== f) try { e = Stripe.JSON.parse(g) } catch (h) { d = h, c = c + "_AND_" + f }
